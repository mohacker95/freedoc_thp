...
ActiveRecord::Schema[7.0].define(version: 2023_02_09_173349) do
  ...
  create_table "doctor_specialty_relations", force: :cascade do |t|
    t.integer "doctor_id"
    t.integer "specialty_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["doctor_id"], name: "index_doctor_specialty_relations_on_doctor_id"
    t.index ["specialty_id"], name: "index_doctor_specialty_relations_on_specialty_id"
  end
